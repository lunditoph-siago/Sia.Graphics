...
public sealed unsafe class ForwardOpaquePipeline
{
    ...
    private ForwardOpaquePipeline(Entity renderPipeline, Entity bindGroupLayout)
    {
        ...
        World world, Entity device, WGPUTextureFormat colorFormat, WGPUTextureFormat depthFormat)
    {
        ...
        var shaderModule = world.OwnWgpu(
            Wgpu.CreateWgslShaderModule(deviceHandle, SceneShaderSource.LoadUnlitForward(), "unlit_forward"));
        ...
        var renderPipeline = world.OwnWgpu(CreateRenderPipeline(
            ...
            colorFormat,
            depthFormat));
        return new ForwardOpaquePipeline(renderPipeline, bindGroupLayout);
    }
